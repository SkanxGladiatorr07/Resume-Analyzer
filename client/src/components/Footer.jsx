...
/**
 * Footer Component
 * Site-wide footer with links, branding, and info
 */
const Footer = () => {
      ...
      <div className="max-w-7xl mx-auto px-4 py-12 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-8">
          ...
          <div className="col-span-1 md:col-span-1">
            ...
            <p className="text-gray-400 text-sm leading-relaxed">
              AI-Powered Resume Analysis Platform helping job seekers optimize their resumes for success
            </p>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  to="/career-assistant?tab=interview"
                  className="text-gray-400 hover:text-blue-400 transition-colors text-sm"
                >
                  Interview Prep
                </Link>
        ...
        <div className="border-t border-gray-700 pt-8 text-center">
          <p className="text-gray-400 text-sm mb-2">
            © {currentYear}{' '}
            <span className="font-semibold text-white">ResumeAI</span>. All rights reserved.
          </p>
          <p className="text-gray-500 text-xs">
            Built with ❤️ by{' '}
            <span className="text-blue-400 font-medium">Skan</span>
